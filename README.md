...
See [CONTRIBUTING.md](CONTRIBUTING.md) for branch hygiene, validation commands, and pull request rules. Repository documentation is indexed in [docs/README.md](docs/README.md).
