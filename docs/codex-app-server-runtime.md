...
RikkaHub pins a validated Codex runtime version so protocol changes in an arbitrary future `latest` release cannot silently replace a known-compatible runtime.
